...
- **Delegated Editing**: Define the *intent* of the seam, but delegate the physical editing of `openapi.yaml` to the [SKILL_OPENAPI_SPECIALIST.md](SKILL_OPENAPI_SPECIALIST.md).
...
3.  **Handoff**: Switch to [SKILL_OPENAPI_SPECIALIST.md](SKILL_OPENAPI_SPECIALIST.md) to apply the changes to `specs/openapi.yaml`.
