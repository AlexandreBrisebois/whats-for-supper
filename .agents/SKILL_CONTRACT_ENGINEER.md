...
- **Delegation**: As a Contract Engineer, you define the *intent* of the seam, but you MUST delegate the actual editing of `openapi.yaml` to the [SKILL_OPENAPI_SPECIALIST.md](SKILL_OPENAPI_SPECIALIST.md).
- **Specialist**: For end-to-end API lifecycle (generation, mocking, wiring), use the Specialist skill.
...
- **Implementation**: Both tasks are powered by `scripts/agent/api_tools.py`.
