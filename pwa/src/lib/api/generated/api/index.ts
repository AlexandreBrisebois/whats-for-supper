...
// @ts-ignore
import { CapturesRequestBuilderNavigationMetadata, type CapturesRequestBuilder } from './captures/index';
// @ts-ignore
import { DiscoveryRequestBuilderNavigationMetadata, DiscoveryRequestBuilderRequestsMetadata, type DiscoveryRequestBuilder } from './discovery/index';
// @ts-ignore
...
// @ts-ignore
import { IngredientsRequestBuilderNavigationMetadata, type IngredientsRequestBuilder } from './ingredients/index';
// @ts-ignore
import { InventoryCapturesRequestBuilderNavigationMetadata, InventoryCapturesRequestBuilderRequestsMetadata, type InventoryCapturesRequestBuilder } from './inventoryCaptures/index';
// @ts-ignore
...
// @ts-ignore
import { ScheduleRequestBuilderNavigationMetadata, ScheduleRequestBuilderRequestsMetadata, type ScheduleRequestBuilder } from './schedule/index';
// @ts-ignore
import { SettingsRequestBuilderNavigationMetadata, type SettingsRequestBuilder } from './settings/index';
// @ts-ignore
import { StreamRequestBuilderRequestsMetadata, type StreamRequestBuilder } from './stream/index';
// @ts-ignore
import { type WorkflowsRequestBuilder, WorkflowsRequestBuilderNavigationMetadata } from './workflows/index';
// @ts-ignore
