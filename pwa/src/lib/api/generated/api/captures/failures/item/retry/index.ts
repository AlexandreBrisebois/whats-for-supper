...
// @ts-ignore
import {
  createCaptureFailureRetryResponseFromDiscriminatorValue,
  serializeCaptureFailureRetryResponse,
  type CaptureFailureRetryResponse,
} from '../../../../../models/index';
// @ts-ignore
import {
 ...
 */
// @ts-ignore
export function createRetry409ErrorFromDiscriminatorValue(
 ...
 */
// @ts-ignore
export function createRetryPostResponseFromDiscriminatorValue(
  parseNode: ParseNode | undefined
): (instance?: Parsable) => Record<string, (node: ParseNode) => void> {
 ...
 */
// @ts-ignore
export function deserializeIntoRetry409Error(
  retry409Error: Partial<Retry409Error> | undefined = {}
): Record<string, (node: ParseNode) => void> {
  return {
    errorCode: (n) => {
      retry409Error.errorCode = n.getStringValue();
    },
    message: (n) => {
 ...
 */
// @ts-ignore
export function deserializeIntoRetryPostResponse(
  retryPostResponse: Partial<RetryPostResponse> | undefined = {}
): Record<string, (node: ParseNode) => void> {
  return {
    data: (n) => {
      retryPostResponse.data = n.getObjectValue<CaptureFailureRetryResponse>(
        createCaptureFailureRetryResponseFromDiscriminatorValue
      );
    },
  };
...
export interface RetryRequestBuilder extends BaseRequestBuilder<RetryRequestBuilder> {
  ...
  ): Promise<RetryPostResponse | undefined>;
  /**
   * Retry a failed capture
   * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
 ...
 */
// @ts-ignore
export function serializeRetry409Error(
  writer: SerializationWriter,
  retry409Error: Partial<Retry409Error> | undefined | null = {},
  isSerializingDerivedType: boolean = false
): void {
  if (!retry409Error || isSerializingDerivedType) {
    return;
  }
 ...
 */
// @ts-ignore
export function serializeRetryPostResponse(
  writer: SerializationWriter,
  retryPostResponse: Partial<RetryPostResponse> | undefined | null = {},
  isSerializingDerivedType: boolean = false
): void {
  if (!retryPostResponse || isSerializingDerivedType) {
    return;
  }
  writer.writeObjectValue<CaptureFailureRetryResponse>(
    'data',
    retryPostResponse.data,
    serializeCaptureFailureRetryResponse
  );
