...
export interface RecipeLibrarySummaryDto extends AdditionalDataHolder, Parsable {
  /**
   * Count of recipes where lastCookedDate IS NULL and deletedAt IS NULL
   */
...
export interface RecipeLibrarySummaryDto_ratings extends AdditionalDataHolder, Parsable {
  /**
   * Count of recipes with rating == 1
   */
  dislike?: number | null;
  /**
   * Count of recipes with rating == 2
   */
  like?: number | null;
  /**
   * Count of recipes with rating == 3
   */
  love?: number | null;
  /**
   * Count of recipes with rating == 0
   */
  unrated?: number | null;
}
