...
export const DISCOVERY_RECIPES: DiscoveryRecipe[] = [
  {
    ...
    description: 'A harmonious blend of sun-dried tomatoes, wilted spinach, and rustic parmesan over linguine.',
  ...
  },
  {
    ...
    description: 'Wild-caught salmon infused with aromatic wood smoke, fresh lemon zest, and rosemary.',
  ...
  },
  {
    ...
    description: 'Roasted sweet potato, black quinoa, and massaged kale dressed in a creamy liquid-gold tahini.',
  ...
  },
  {
    ...
    description: 'Flaky artisanal pastry topped with garden-fresh heirlooms, goat cheese, and balsamic reduction.',
  ...
  },
  {
    ...
    description: 'Succulent organic chicken roasted with lavender, thyme, and seasonal baby vegetables.',
  ...
  },
  {
    ...
    description: 'Creamy Arborio rice slowly folded with foraged mushrooms, truffle oil, and aged Pecorino.',
