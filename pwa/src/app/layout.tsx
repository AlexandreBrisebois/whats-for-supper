  ...
  return (
    <html lang="en" className={`${outfit.variable} ${inter.variable}`}>
      <head>
        ...
        <link
          rel="apple-touch-startup-image"
          media="screen and (device-width: 360px) and (device-height: 780px) and (-webkit-device-pixel-ratio: 3) and (orientation: portrait) and (prefers-color-scheme: light)"
        ...
        <link
          rel="apple-touch-startup-image"
          media="screen and (device-width: 360px) and (device-height: 780px) and (-webkit-device-pixel-ratio: 3) and (orientation: portrait) and (prefers-color-scheme: dark)"
          href="/splash/dark/splash-1080x2340.png"
        />
        <link
          rel="apple-touch-startup-image"
        ...
        <link
          ...
          href="/splash/dark/splash-1536x2048.png"
        />
        <link
          rel="apple-touch-startup-image"
          ...
          href="/splash/dark/splash-1668x2388.png"
        />
        <link
          rel="apple-touch-startup-image"
          ...
          href="/splash/dark/splash-2048x2732.png"
        />
