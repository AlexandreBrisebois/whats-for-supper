  ...
  return (
    <main className="flex min-h-dvh flex-col items-center justify-center gap-8 px-6 py-12">
      <div className="text-center">
        <h1 className="text-4xl font-bold text-sage-green">What&apos;s for Supper?</h1>
      ...
      <Link
        ...
        className="rounded-2xl bg-sage-green px-8 py-4 text-lg font-semibold text-cream shadow-card transition-opacity hover:opacity-90 active:opacity-75"
      >
        Get Started
      </Link>
    </main>
