> **Historical reference — retired 2026-09-25.** Phase 3 removed its dietary/health assumptions. This document is preserved as history and is not active implementation guidance.
...
Historical pointers: `.agents/core/specification-workflow.md` and
`.agents/core/execution-harness.md`. Record actual evidence before marking a task done.
